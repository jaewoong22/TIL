...
<span style="color:gray">(이때까지 못 찾으면 탐색 실패 -1, false, error 등 return)<span><br>
...
<span style="color:gray"> *log 2n의 경우 밑이 10인 log n으로 계산한다.<br>
...
그러므로 O(log n)은 로그의 밑과 상관없이 로그 시간 알고리즘에 대한 표준 표기법이 된다.</span>
